    ...
    <>
      <div className='relative h-[300px] overflow-hidden'>
        {productImages.map((image, i) => {
          ...
          // const opacity = currentIndex === i ? '100' : '0';
          return (
            <img
              src={image}
              key={i}
        ...
        <ButtonIcon
          buttonClass='absolute left-4 v-align-middle bg-white w-9 h-9 rounded-full text-center shadow-md'
          handleClick={indexDecrement}
          icon={<Previous svgClass='w-[10px] -mt-[3px] -ml-[2px]' />}
        />
        <ButtonIcon
          buttonClass='absolute right-4 v-align-middle bg-white w-9 h-9 rounded-full text-center shadow-md'
